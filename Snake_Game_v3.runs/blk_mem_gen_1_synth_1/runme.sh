...
HD_PWD='H:/Documents/vivado_projs/ES3B2/Snake_Game_v1.4_workingApple/Snake_Game_v1.4_workingApple/Snake_Game_v1.4_workingApple.runs/blk_mem_gen_1_synth_1'
cd "$HD_PWD"
